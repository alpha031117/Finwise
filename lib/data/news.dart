...
class NewDatabase {
  static List<News> newss = [
    News(
        ...
        points: 0,
        quiztitle:
            "Did the stock market decline on March 8, 2024, due to a jobs report indicating a cooling labor market, despite adding more jobs than economists had anticipated?",
        options: {
          'True': true,
          'False': false,
        }),
