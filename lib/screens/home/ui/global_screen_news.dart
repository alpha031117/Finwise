...
class GlobalNewsScreen extends StatefulWidget {
  ...
  const GlobalNewsScreen({Key? key, required this.globalnews})
      : super(key: key);
  ...
  void toggleBookmark() {
    setState(() {
      ...
      if (widget.globalnews.isBookMarked) {
        ...
        SavedNewsDatabase.addSavedGlobalNews(widget.globalnews);
      } else {
        // If unbookmarked, remove the news from savedNews
        SavedNewsDatabase.removeSavedGlobalNews(widget.globalnews);
      }
    });
  }
        ...
        appBar: PreferredSize(
          ...
          child: AppBar(
            ...
            actions: <Widget>[
              IconButton(
                icon: Icon(
                  widget.globalnews.isBookMarked
                      ? Icons.bookmark
              ...
              children: [
                Row(
                    ...
                    children: <Widget>[
                      ...
                      CircleAvatar(
                        backgroundImage:
                            AssetImage('${widget.globalnews.imagePath}'),
                        radius: 9.5,
                      ),
                      SizedBox(width: 5),
                      Text(
                          ...
                          children: [
                            Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 3.0),
                                Text(
                                  getfollowersNum(widget.globalnews.followers)
                                          .toString() +
                                      getfollowers(
                                          widget.globalnews.followers) +
                                      ' ' +
                                      'followers',
                                  style: TextStyle(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          for (int i = 0;
                              i < widget.globalnews.options.length;
                              i++)
                            OptionWidget(
                              option:
                                  widget.globalnews.options.keys.toList()[i],
                              color: isPressed
                                  ? widget.globalnews.options.values
                                              .toList()[i] ==
                                          true
                                      ? Colors.green
                                      : Colors.red
