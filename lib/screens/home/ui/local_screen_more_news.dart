...
class local_more_news_screen extends StatefulWidget {
  final LocalMoreNews localmorenews;
  const local_more_news_screen({Key? key, required this.localmorenews}) : super(key: key);

  @override
  State<local_more_news_screen> createState() => _local_more_news_screen_State();
}
            ...
            children: [
              Row(
                ...
                children: <Widget>[
                  SizedBox(width: 4),
                  CircleAvatar(
                    backgroundImage: AssetImage('${widget.localmorenews.imagePath}'),
                    radius: 9.5,
                  ),
                  SizedBox(width: 5),
                  Text(
                    '${widget.localmorenews.com}',
                    style: TextStyle(
                      fontSize: 14.0,
                  ...
                  SizedBox(width: 3),
                  Text(
                    getMonthName(widget.localmorenews.date.month) +
                        ' ' +
                        '${widget.localmorenews.date.day}, ${widget.localmorenews.date.year}', // Format date
              ...
              Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                          image: AssetImage(
                              '${widget.localmorenews.imagePath}'), // Use AssetImage for local assets
                          fit: BoxFit.cover,
                        ),
                      ),
                    ),
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 3.0),
                            Text(
                              getfollowersNum(widget.localmorenews.followers).toString()+getfollowers(widget.localmorenews.followers)+' '+'followers' ,
                              style:
