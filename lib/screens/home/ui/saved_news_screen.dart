...
class SavedNewssScreen extends StatefulWidget {
  // final List<SearchScreenNews> savedNews;
  final List<News> savedNewsCard;

  SavedNewssScreen({required this.savedNewsCard} );

  @override
  State<SavedNewssScreen> createState() => _SavedNewssScreenState();
}

class _SavedNewssScreenState extends State<SavedNewssScreen> {
  @override
